...
api_key = 'AIzaSyDCLBVSflr8cjgBH4VwMsqzq9sMZ6reOg8'
...
def analyze(playlist_id):
    ...
    ttle = playlist_response['items'][0]['snippet']['title']
    ...
    return [time, no_of_videos, popular_videos, ttle]

    

# arr = analyze("PLu0W_9lII9ahR1blWXxgSlL4y9iQBnLpR")
# print(arr[2])